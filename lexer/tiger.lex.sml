...
fun yyQ70 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
and yyQ68 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction42(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"i"
              then yyQ70(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"i"
              ...
              then if inp = #"a"
                  ...
                  then yyQ70(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
                  else yyQ71(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
            else if inp = #"u"
              then yyQ68(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
            else if inp < #"u"
              then if inp = #"m"
        ...
        | SOME(inp, strm') =>
            if inp = #"i"
              ...
              then if inp = #"l"
                  ...
                  then if inp = #"j"
                      then yyQ68(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
                      else yyQ109(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
                else if inp <= #"q"
                  then yyQ68(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
                  else yyQ70(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
            else if inp = #"|"
...
fun yyQ47 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction34(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              then yyQ115(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
            else if inp < #">"
              then if inp = #"="
...
fun yyQ45 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction20(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ116(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
...
fun yyQ20 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction62(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"d"
              then yyQ23(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
